...
import { $ as $$Layout } from '../chunks/Layout_BIedGx1z.mjs';
/* empty css                                 */
...
function RegisterForm(props) {
  ...
  createSignal(false);
  const [isLoading, setIsLoading] = createSignal(false);
  return ssr(_tmpl$3$2, ssrHydrationKey(), escape(createComponent$1(Show, {
    get when() {
      return props.onClose;
    },
    get children() {
    ...
    get children() {
      return ssr(_tmpl$2$2, ssrHydrationKey(), escape(error()));
    }
  })), ssrAttribute("disabled", isLoading(), true), isLoading() ? "Creating account..." : "Create Account");
}

var _tmpl$$4 = ["<div", ' class="fixed inset-0 bg-black bg-opacity-60 backdrop-blur-sm flex items-center justify-center z-[9999] p-4"><div class="bg-gray-900 rounded-lg shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto"><!--$-->', "<!--/--><!--$-->", "<!--/--></div></div>"];
function AuthModal(props) {
  ...
  return createComponent$1(Portal, {
    get children() {
      return ssr(_tmpl$$4, ssrHydrationKey(), escape(createComponent$1(Show, {
        get when() {
          return mode() === "login";
        },
        get children() {
...
var _tmpl$$3 = ["<div", ' class="flex items-center space-x-3 text-white"><div class="flex flex-col leading-tight text-right"><span class="text-sm text-gray-300">Welcome</span><strong class="text-base">', '</strong></div><button title="Sign out" class="bg-gray-800 hover:bg-gray-700 text-white px-3 py-2 rounded">Sign out</button></div>'];
function UserProfile(props) {
  return ssr(_tmpl$$3, ssrHydrationKey(), escape(userProfile()?.username) || escape(user()?.email?.split("@")[0]) || "User");
}

var _tmpl$$2 = ["<div", '><button class="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded mr-2">REGISTER</button><button class="bg-blue-700 hover:bg-blue-600 text-white px-4 py-2 rounded">LOG IN</button></div>'];
...
var _tmpl$$1 = ["<div", ` class="space-y-6"><div class="bg-gradient-to-r from-blue-900/50 to-blue-800/50 p-6 rounded-lg border border-blue-500/30"><h3 class="text-2xl font-bold text-white mb-4">Welcome to memestockmarket.fun</h3><p class="text-gray-300 text-lg leading-relaxed">The world's first decentralized meme stock market where internet culture meets financial innovation. Trade, invest, and profit from the most viral memes on the internet.</p></div><div class="grid md:grid-cols-2 gap-6"><div class="bg-blue-800/50 p-6 rounded-lg border border-blue-700"><div class="flex items-center mb-4"><div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-4"><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg></div><h4 class="text-xl font-semibold text-white">Trade Memes</h4></div><p class="text-gray-400">Buy and sell shares of viral memes. Watch your portfolio grow as memes gain popularity across social media platforms.</p></div><div class="bg-blue-800/50 p-6 rounded-lg border border-blue-700"><div class="flex items-center mb-4"><div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-4"><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path></svg></div><h4 class="text-xl font-semibold text-white">Community Driven</h4></div><p class="text-gray-400">Join a vibrant community of meme enthusiasts, traders, and creators. Share insights and discover the next big meme.</p></div></div></div>`], _tmpl$2$1 = ["<div", ' class="space-y-6"><div class="grid gap-6"><div class="bg-gradient-to-r from-blue-900/30 to-blue-800/30 p-6 rounded-lg border border-blue-500/30"><h4 class="text-xl font-bold text-white mb-3 flex items-center"><span class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 text-sm">📈</span>Real-time Meme Trading</h4><p class="text-gray-300">Track meme performance across social platforms with live price updates and market sentiment analysis.</p></div><div class="bg-gradient-to-r from-blue-900/30 to-blue-700/30 p-6 rounded-lg border border-blue-500/30"><h4 class="text-xl font-bold text-white mb-3 flex items-center"><span class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 text-sm">🎯</span>Smart Portfolio Management</h4><p class="text-gray-300">Advanced analytics and AI-powered recommendations to optimize your meme investment strategy.</p></div><div class="bg-gradient-to-r from-blue-900/30 to-blue-800/30 p-6 rounded-lg border border-blue-500/30"><h4 class="text-xl font-bold text-white mb-3 flex items-center"><span class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 text-sm">🚀</span>Meme Launchpad</h4><p class="text-gray-300">Launch your own memes and watch them compete in the marketplace. Creators earn royalties from trading activity.</p></div><div class="bg-gradient-to-r from-blue-900/30 to-blue-700/30 p-6 rounded-lg border border-blue-500/30"><h4 class="text-xl font-bold text-white mb-3 flex items-center"><span class="w-8 h-8 bg-blue-600 rounded-full flex items-center justify-center mr-3 text-sm">🏆</span>Leaderboards & Rewards</h4><p class="text-gray-300">Compete with other traders, climb the leaderboards, and earn exclusive rewards and NFT badges.</p></div></div></div>'], _tmpl$3$1 = ["<div", ` class="space-y-8"><div class="text-center mb-8"><h3 class="text-2xl font-bold text-white mb-4">Start Trading Memes in 3 Simple Steps</h3><p class="text-gray-400">Join thousands of traders in the world's most entertaining financial market</p></div><div class="grid md:grid-cols-3 gap-8"><div class="text-center"><div class="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-white">1</span></div><h4 class="text-xl font-semibold text-white mb-3">Create Account</h4><p class="text-gray-400">Sign up with your email and get started with virtual currency to begin trading immediately.</p></div><div class="text-center"><div class="w-16 h-16 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-white">2</span></div><h4 class="text-xl font-semibold text-white mb-3">Discover Memes</h4><p class="text-gray-400">Browse trending memes, analyze their social media performance, and identify investment opportunities.</p></div><div class="text-center"><div class="w-16 h-16 bg-blue-700 rounded-full flex items-center justify-center mx-auto mb-4"><span class="text-2xl font-bold text-white">3</span></div><h4 class="text-xl font-semibold text-white mb-3">Trade & Profit</h4><p class="text-gray-400">Buy low, sell high, and watch your portfolio grow as memes go viral across the internet.</p></div></div><div class="bg-gradient-to-r from-blue-900/20 to-blue-800/20 p-6 rounded-lg border border-blue-500/30 mt-8"><div class="flex items-start"><div class="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mr-4 flex-shrink-0"><svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg></div><div><h4 class="text-lg font-semibold text-white mb-2">Pro Tip</h4><p class="text-gray-300">Follow social media trends, monitor engagement metrics, and use our sentiment analysis tools to make informed trading decisions.</p></div></div></div></div>`], _tmpl$4$1 = ["<div", ' class="space-y-6"><div class="text-center mb-8"><h3 class="text-2xl font-bold text-white mb-4">Join Our Growing Community</h3><p class="text-gray-400">Connect with meme traders, creators, and enthusiasts from around the world</p></div><div class="grid md:grid-cols-1 gap-6 max-w-md mx-auto"><div class="bg-blue-500/10 p-6 rounded-lg border border-blue-500/30"><div class="flex items-center mb-4"><div class="w-12 h-12 bg-blue-500 rounded-lg flex items-center justify-center mr-4"><svg class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"></path></svg></div><div><h4 class="text-xl font-semibold text-white">X.com</h4><p class="text-gray-400">Latest updates & news</p></div></div><p class="text-gray-300 mb-4">Follow us for market updates, new meme launches, and community highlights.</p><button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">Follow us on X.com</button></div></div><div class="bg-gradient-to-r from-blue-900/20 to-blue-800/20 p-6 rounded-lg border border-blue-500/30"><h4 class="text-xl font-bold text-white mb-4">Community Stats</h4><div class="grid grid-cols-2 md:grid-cols-4 gap-4"><div class="text-center"><div class="text-2xl font-bold text-blue-400">50K+</div><div class="text-gray-400 text-sm">Active Traders</div></div><div class="text-center"><div class="text-2xl font-bold text-blue-400">1M+</div><div class="text-gray-400 text-sm">Memes Traded</div></div><div class="text-center"><div class="text-2xl font-bold text-blue-400">$10M+</div><div class="text-gray-400 text-sm">Volume Traded</div></div><div class="text-center"><div class="text-2xl font-bold text-blue-400">24/7</div><div class="text-gray-400 text-sm">Market Open</div></div></div></div></div>'], _tmpl$5$1 = ["<div", ' class="min-h-screen bg-gradient-to-b from-blue-900 to-blue-700 text-white p-6"><div class="max-w-6xl mx-auto"><div class="text-center mb-12"><h1 class="text-4xl md:text-6xl font-bold text-white mb-4">About <span class="text-green-400">memestockmarket.fun</span></h1><p class="text-xl text-gray-300 max-w-3xl mx-auto">Where internet culture meets financial innovation. The future of meme trading is here.</p></div><div class="flex flex-wrap justify-center gap-2 mb-8">', '</div><div class="bg-gray-900/50 backdrop-blur-sm rounded-2xl p-8 border border-gray-700/50 shadow-2xl">', '</div><div class="text-center mt-12"><div class="bg-gradient-to-r from-blue-600 to-blue-700 p-8 rounded-2xl"><h3 class="text-2xl font-bold text-white mb-4">Ready to Start Trading?</h3><p class="text-gray-200 mb-6">Join thousands of traders and start your meme investment journey today!</p><div class="flex justify-center"><button class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center gap-2"><svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"></path></svg>Follow us on X.com</button></div></div></div></div></div>'], _tmpl$6$1 = ["<button", ' class="', '">', "</button>"];
function About() {
  const [activeSection, setActiveSection] = createSignal("overview");
  const sections = {
    overview: {
      title: "Overview",
      content: ssr(_tmpl$$1, ssrHydrationKey())
    },
    features: {
      title: "Features",
      content: ssr(_tmpl$2$1, ssrHydrationKey())
    },
    howItWorks: {
      title: "How It Works",
      content: ssr(_tmpl$3$1, ssrHydrationKey())
    },
    community: {
      title: "Community",
      content: ssr(_tmpl$4$1, ssrHydrationKey())
    }
  };
  return ssr(_tmpl$5$1, ssrHydrationKey(), escape(Object.entries(sections).map(([key, section]) => ssr(_tmpl$6$1, ssrHydrationKey(), `px-6 py-3 rounded-lg font-semibold transition-all duration-300 ${activeSection() === key ? "bg-blue-600 text-white shadow-lg shadow-blue-600/25" : "bg-gray-800 text-gray-300 hover:bg-gray-700 hover:text-white"}`, escape(section.title)))), escape(sections[activeSection()].content));
}

var _tmpl$ = ["<div", ' class="mt-4 relative"><img', ' alt="Preview" class="max-w-full h-48 object-cover rounded-lg"><button class="absolute top-2 right-2 bg-red-500 hover:bg-red-600 text-white rounded-full w-8 h-8 flex items-center justify-center transition-colors">×</button></div>'], _tmpl$2 = ["<div", ' class="min-h-screen bg-gradient-to-b from-blue-900 to-blue-700 p-6"><div class="max-w-2xl mx-auto"><div class="text-center mb-8"><h1 class="text-4xl font-bold text-white mb-2">Community Feed</h1><p class="text-gray-300">Share your trading insights and connect with fellow meme investors</p></div><div class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 mb-6 border border-gray-700/50"><div class="flex items-start space-x-4"><img src="https://api.dicebear.com/7.x/avataaars/svg?seed=You" alt="Your avatar" class="w-12 h-12 rounded-full"><div class="flex-1"><textarea', ` placeholder="What's happening in the meme market?" class="w-full bg-gray-700/50 text-white placeholder-gray-400 rounded-lg p-4 border border-gray-600 focus:border-blue-500 focus:outline-none resize-none" rows="3"></textarea><!--$-->`, '<!--/--><div class="flex items-center justify-between mt-4"><div class="flex items-center space-x-4"><label class="cursor-pointer text-blue-400 hover:text-blue-300 transition-colors"><input type="file" accept="image/*,video/*" class="hidden"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg></label><span class="text-gray-400 text-sm">', "</span></div><button", ' class="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-6 py-2 rounded-lg font-semibold transition-colors">Post</button></div></div></div></div><div class="space-y-6">', "</div></div></div>"], _tmpl$3 = ["<img", ' alt="Post image" class="w-full max-h-96 object-cover rounded-lg mb-4">'], _tmpl$4 = ["<div", ' class="mt-4 space-y-3">', "</div>"], _tmpl$5 = ["<div", ' class="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700/50"><div class="flex items-center space-x-3 mb-4"><img', ' alt="', '" class="w-10 h-10 rounded-full"><div class="flex-1"><h3 class="text-white font-semibold">', '</h3><p class="text-gray-400 text-sm">', '</p></div></div><p class="text-gray-200 mb-4 leading-relaxed">', "</p><!--$-->", '<!--/--><div class="flex items-center space-x-6 py-3 border-t border-gray-700"><button class="', '"><svg class="w-5 h-5"', ' stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg><span>', '</span></button><button class="flex items-center space-x-2 text-gray-400 hover:text-blue-500 transition-colors"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg><span>', '</span></button><button class="flex items-center space-x-2 text-gray-400 hover:text-green-500 transition-colors"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.367 2.684 3 3 0 00-5.367-2.684z"></path></svg><span>Share</span></button></div><!--$-->', '<!--/--><div class="flex items-center space-x-3 mt-4"><img src="https://api.dicebear.com/7.x/avataaars/svg?seed=You" alt="Your avatar" class="w-8 h-8 rounded-full"><div class="flex-1 flex space-x-2"><input type="text"', ' placeholder="Write a comment..." class="flex-1 bg-gray-700/50 text-white placeholder-gray-400 rounded-lg px-4 py-2 border border-gray-600 focus:border-blue-500 focus:outline-none"><button', ' class="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-600 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg transition-colors">Post</button></div></div></div>'], _tmpl$6 = ["<div", ' class="flex items-start space-x-3 bg-gray-700/30 rounded-lg p-3"><img', ' alt="', '" class="w-8 h-8 rounded-full"><div class="flex-1"><div class="flex items-center space-x-2 mb-1"><span class="text-white font-medium text-sm">', '</span><span class="text-gray-400 text-xs">', '</span></div><p class="text-gray-200 text-sm">', '</p><button class="', '"><svg class="w-4 h-4"', ' stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg><span>', "</span></button></div></div>"];
function Feed() {
  const savePostsToStorage = (postsData) => {
    try {
  ...
  const [posts, setPosts] = createSignal(loadPostsFromStorage());
  ...
  return ssr(_tmpl$2, ssrHydrationKey(), ssrAttribute("value", escape(newPostContent(), true), false), escape(createComponent$1(Show, {
    get when() {
      return previewUrl();
    },
    get children() {
      return ssr(_tmpl$, ssrHydrationKey(), ssrAttribute("src", escape(previewUrl(), true), false));
    }
    ...
    children: (post) => ssr(_tmpl$5, ssrHydrationKey(), ssrAttribute("src", escape(post.avatar, true), false), `${escape(post.author, true)} avatar`, escape(post.author), escape(formatTimeAgo(post.timestamp)), escape(post.content), escape(createComponent$1(Show, {
      get when() {
        return post.image;
      },
      get children() {
        return ssr(_tmpl$3, ssrHydrationKey() + ssrAttribute("src", escape(post.image, true), false));
      }
      ...
      get children() {
        return ssr(_tmpl$4, ssrHydrationKey(), escape(createComponent$1(For, {
          ...
          children: (comment) => ssr(_tmpl$6, ssrHydrationKey(), ssrAttribute("src", escape(comment.avatar, true), false), `${escape(comment.author, true)} avatar`, escape(comment.author), escape(formatTimeAgo(comment.timestamp)), escape(comment.content), `flex items-center space-x-1 mt-2 text-xs transition-colors ${comment.isLiked ? "text-red-500" : "text-gray-400 hover:text-red-500"}`, ssrAttribute("fill", comment.isLiked ? "currentColor" : "none", false), escape(comment.likes))
        })));
      }
