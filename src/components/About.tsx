    ...
    community: {
      ...
      content: (
        <div class="space-y-6">
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div class="bg-[#5865F2]/10 p-6 rounded-lg border border-[#5865F2]/30">
              <div class="flex items-center mb-4">
                <div class="w-12 h-12 bg-[#5865F2] rounded-lg flex items-center justify-center mr-4">
                ...
                <div>
                  <h4 class="text-xl font-semibold text-white">Discord Server</h4>
                  <p class="text-gray-400">24/7 active community</p>
                </div>
              </div>
              <p class="text-gray-300 mb-4">Join our Discord for real-time market discussions, trading tips, and exclusive alpha calls.</p>
              <button class="bg-[#5865F2] hover:bg-[#4752C4] text-white px-4 py-2 rounded-lg transition-colors">
                Join Discord
              </button>
            </div>
            ...
            <div class="bg-blue-500/10 p-6 rounded-lg border border-blue-500/30">
              <div class="flex items-center mb-4">
                ...
                <div>
                  <h4 class="text-xl font-semibold text-white">Twitter/X</h4>
              ...
              <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg transition-colors">
                Follow @MemeStockMarket
              </button>
            </div>
          </div>
          
          <div class="bg-gradient-to-r from-green-900/20 to-blue-900/20 p-6 rounded-lg border border-green-500/30">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div class="text-center">
                <div class="text-2xl font-bold text-purple-400">$10M+</div>
    ...
    <div class="min-h-screen bg-gradient-to-b from-blue-900 to-blue-700 p-6">
      <div class="max-w-6xl mx-auto">
        ...
        <div class="text-center mt-12">
          <div class="bg-gradient-to-r from-green-600 to-blue-600 p-8 rounded-2xl">
